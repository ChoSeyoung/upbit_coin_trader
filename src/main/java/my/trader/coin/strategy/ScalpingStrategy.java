...
public class ScalpingStrategy {
    ...
    private static final BigDecimal STOP_LOSS_PERCENTAGE = BigDecimal.valueOf(0.02); // 2% 손절매
    private static final BigDecimal TAKE_PROFIT_PERCENTAGE = BigDecimal.valueOf(0.02); // 2% 목표 이익
